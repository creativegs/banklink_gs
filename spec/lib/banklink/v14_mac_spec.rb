  ...
  describe "#generate_v14_mac" do
    it "should return a base 64 encoded string" do
      ...
      Timecop.freeze("2016-09-08 12:00".to_datetime) do
        expect(swed14_helper.generate_v14_mac).to eq "RbiJFYMZ/ZxJxi30j3Orb3x4e8ZqX0mAOwW4ZAm94ViY8sTgRu0Klw81wl9rE1RXbtlwcsyapPfu2r+GdUVoHArHeePXdB5UIgFsv9UsPJqvkE0TAhhVkh96ZkoNSG5O+HuylbELhGTNgnI5LS3tB8MYusoPskxGmQQg+KqaSHc="
      end
